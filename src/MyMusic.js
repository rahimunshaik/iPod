...
import sound from './assets/music/Zarazara.mp3'
        ...
        return(
            <div style={styles.myMusicContainer}>
                ...
                <div style={styles.info}>
                    <img style={styles.image} src="https://dailyhindilyrics.com/wp-content/uploads/2021/05/Zara-Zara-Lyrics-Male-Version.jpg"></img>
                    <div style={styles.subInfo}>
                        <h4 style={{marginBottom:'0.5rem'}}>ZaraZara</h4>
                        <p style={{marginBottom:'0'}}>Jal Raj</p>
                        <p>Singer Jal Raj</p>
                    </div>
