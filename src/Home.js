            ...
            <div style={styles.homeScreen} id='home-screen'>
                <div style={styles.menuList} id='menu-list'>
                    <div style={styles.titleBar}>
                        <p style={{fontWeight:'bold'}}>Cell-Pod</p>
                    ...
                    <ListGroup style={{borderRadius:'0'}}>
                        <ListGroup.Item style={{border:'0',padding: '0.2rem 0.6rem'}} className={this.props.activeItem==='NowPlaying'?'active':''}>
                            Playing {this.props.activeItem==='NowPlaying'?<span style={{float:'right' ,fontWeight:'bold'}}>&gt;</span>:''}
                        </ListGroup.Item>
...
const styles = {
    ...
    imageContainer : {
        ...
        height : '100%',
        width : '70%',
        backgroundImage : 'url("https://www.androidguys.com/wp-content/uploads/2015/12/Wave-Wallpapers-1.jpg")',
